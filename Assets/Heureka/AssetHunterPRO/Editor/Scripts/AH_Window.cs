...
namespace HeurekaGames.AssetHunterPRO
{
    public class AH_Window : EditorWindow
    {
        ...
        private void initializeGUIContent()
        {
            ...
            guiContentLoadBuildInfo = new GUIContent("Load", AH_EditorData.Instance.LoadLogIcon.Icon, "Load info from one of a previous build");
            guiContentGenerateBuildInfo = new GUIContent("Build", AH_EditorData.Instance.GenerateIcon.Icon, "Generate buildinfo manually. Requires enabled scenes in buildsettings");
        ...
        private void doHeader()
        {
            ...
            if (doSelectionButton(guiContentReadme))//, /*GUIStyle.none,*/ GUILayout.MaxHeight(18)))
                Heureka_PackageDataManagerEditor.SelectReadme();
